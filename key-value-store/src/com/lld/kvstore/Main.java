...
import com.lld.kvstore.api.*;
import com.lld.kvstore.application.KeyValueStoreImpl;
import com.lld.kvstore.application.commands.*;
...
public class Main {
    ...
    private static void testCommandPattern(CommandBus commandBus, KeyValueStore store) {
        ...
        Command deleteCommand = new DeleteKeyCommand(store, "command_test");
