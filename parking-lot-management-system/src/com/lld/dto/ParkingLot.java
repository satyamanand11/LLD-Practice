...
public class ParkingLot {
    ...
    private ParkingLot(String name){
        ...
        freeParkingSpots= new ConcurrentHashMap<>();
        occupiedParkingSpots= new ConcurrentHashMap<>();
        freeParkingSpots.put(ParkingSpotEnum.MINI, new CopyOnWriteArrayList<>());
        freeParkingSpots.put(ParkingSpotEnum.COMPACT, new CopyOnWriteArrayList<>());
        freeParkingSpots.put(ParkingSpotEnum.LARGE, new CopyOnWriteArrayList<>());

        occupiedParkingSpots.put(ParkingSpotEnum.MINI, new CopyOnWriteArrayList<>());
        occupiedParkingSpots.put(ParkingSpotEnum.COMPACT, new CopyOnWriteArrayList<>());
        occupiedParkingSpots.put(ParkingSpotEnum.LARGE, new CopyOnWriteArrayList<>());
    }
